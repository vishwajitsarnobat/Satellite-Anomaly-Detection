''' The data available in datasets is recorded for different dates and for different intervals. This code was to count the total
number of common timestamps within all the files. 
The result obtained was about 6000 days of data which is common among all. '''
